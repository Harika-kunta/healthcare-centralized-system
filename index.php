...
<nav>
    <div class="nav-wrapper c-gradient">
        <div class="container">
            <a href="index.php" class="brand-logo c-brand center">Health Care Centralized system</a>
        </div>
    </div>
</nav>
                        ...
                        <form class="col s12" action="add.php" method="post">
                            ...
                            <div class="input-field col s12">
                                <select class="icons" id="desig" name="desig" onchange="toggleForm()">
                                    ...
                                    <option value="Pharmacist" data-icon="./img/doctor.png" class="left circle">Pharmacist
                                    </option>
                                    <option value="Lab Technician" data-icon="./img/doctor.png" class="left circle">Lab Technician
                                    </option>
                                </select>
