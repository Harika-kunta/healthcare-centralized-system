...
?>
    ...
    <div class="container">
                ...
                <div class="row">
                    <form class="col s12" action="" method="get">
                        <div class="input-field col s10">
                            <input id="aadhar_id" type="text" name="aadhar_id" required>
                            <label for="aadhar_id">Enter Patient's Aadhar card number</label>
                        </div>
        ...
        <div class="row">
            ...
            $aadhar_id = mysqli_real_escape_string($mysqli, $_GET['aadhar_id']);
            $res_profile = mysqli_query($mysqli, "SELECT * FROM `patient_record` WHERE `aadhar_id` LIKE '" . $aadhar_id . "'");
                        ...
                        <div class="row">
                            ...
                            <table class="striped responsive-table">
                                ...
                                while ($res = mysqli_fetch_array($res_record)) {
                                    ...
                                    echo "<h5 class='center'>Oops! Patient doesn't have any records yet</h5>";
                                }
                                ?>
                                </tbody>
                            </table>
        ...
        <div class="modal-content">
            <div class="row">
                <div class="col s6 offset-s3 center">
                    ...
                    <input id="aadhar_id" name="aadhar_id" value=<?php echo $aadhar_id; ?>>
                    <br>
                    </div>
                    <div class="input-field col s12">
