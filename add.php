...
//        true
        ...
        if($desig == 'Patient') {
            $aadhar_id = mysqli_real_escape_string($mysqli, $_POST['aadhar_id']);
            ...
            // setting query statement
            $query = "INSERT INTO `patient_record` (`r_id`, `p_id`,`aadhar_id`, `first_name`, `middle_name`, `last_name`, `gender`, `dob`, `blood_group`, `height`, `weight`, `allergy`, `insurance`, `address`, `city`, `state`, `nationality`, `pincode`, `marital_status`, `phone`, `email`, `emergency-contact`) VALUES (NULL, '".$id."', '".$aadhar_id."', '".$firstname."', '".$middlename."', '".$lastname."', '".$gender."', '".$dob."', '".$blood."', '".$height."', '".$weight."', '".$allergy."', '".$insurance."', '".$address."', '".$city."', '".$state."', '".$country."', '".$pin."', '".$marital."', '".$phone."', '".$email."', '".$emerg_phone."')";
            //executing query and retrieving id
            ...
            $pharmacy_name = mysqli_real_escape_string($mysqli, $_POST['pharmacy_name']);
            // setting query statement
            $query = "INSERT INTO `pharmacist_record` (`r_id`, `ph_id`, `first_name`, `middle_name`, `last_name`, `pharmacy_name`, `phone`, `email`) VALUES (NULL, '".$id."', '".$firstname."', '".$middlename."', '".$lastname."', '".$pharmacy_name."', '".$phone."', '".$email."')";
            //executing query and retrieving id
            $ph_res = mysqli_query($mysqli, $query);
            if($ph_res){
                header('Location: index.php');
            }
            else{
        ...
        else if($desig == 'Lab Technician') {
            $lab_name = mysqli_real_escape_string($mysqli, $_POST['lab_name']);
            // setting query statement
            $query = "INSERT INTO `lab_technician_record` (`r_id`, `l_id`, `first_name`, `middle_name`, `last_name`, `laboratory_name`, `phone`, `email`) VALUES (NULL, '".$id."', '".$firstname."', '".$middlename."', '".$lastname."', '".$lab_name."', '".$phone."', '".$email."')";
            //executing query and retrieving id
            $lab_res = mysqli_query($mysqli, $query);
            if($lab_res){
                header('Location: index.php');
            }
            else{
