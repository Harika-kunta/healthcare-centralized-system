...
//        echo "The file ". basename( $_FILES["report"]["name"]). " has been uploaded.";
        ...
        $query = "INSERT INTO `patient_health_record` (`r_id`, `aadhar_id`, `testname`, `medical_report`, `last_consulted_dr`, `last_consulted_dr_phone`, `consulted_date`) VALUES (NULL, '".$aadhar_id."', '".$testname."', '".$target_file."', '".$drname."', '".$drnumber."', '".$drdate."')";
        echo $query;
