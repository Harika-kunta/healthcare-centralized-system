...
var ph_form = '<div id="pharmacist_form"> <div class="input-field col s12"> <input id="pharmacy_name" type="text" name="pharmacy_name" required> <label for="pharmacy_name">Pharmacy Name</label> </div></div>';

var l_form =  '<div id="lab_technician_form"> <div class="input-field col s12"> <input id="lab_name" type="text" name="lab_name" required> <label for="lab_name">Laboratory Name</label> </div></div>';
...
// calling to set the city select box for the default selected state
        ...
        optional_fields.innerHTML = ph_form;
    }
    else if(desig === 'Lab Technician'){
        optional_fields.innerHTML = l_form;
    }
